...
class Notifications extends StatefulWidget {
  ...
  Notifications({this.groupId, this.userName, this.groupName});
  @override
...
class _NotificationsState extends State<Notifications> {
  ...
  _getUserAuthAndJoinedGroups() async {
    ...
    await DatabaseService(uid: _user.uid)
        .getpendingrequests(widget.groupId)
        .then((snapshots) {
      // print(snapshots);
      setState(() {
              ...
              return ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return ListTile(
                      ...
                      title: Text(_destructureName(triplist[index].username)),
                      subtitle:
                          Text(_destructureName(triplist[index].tripname)),
                      trailing: Column(
                        children: [
                          InkWell(
                            onTap: () async {
                              ...
                              await DatabaseService(uid: triplist[index].userid)
                                  .togglingTripJoin(
